...
if (isset($_POST['register'])) {
	...
	if (count($errors)==0) {
		...
		$sql= "INSERT INTO users (user_name, fname, lname, email, DOB, password, hash_code) VALUES ('".$_POST['user_name']."', '$fname', '$lname', '$email', '$date','$password','$hash')";
...
if (isset($_POST['login'])) {
	...
	if (empty($username)) {array_push($errors, "username is required");}
	if (empty($password1)) {array_push($errors, "you must enter your password to continue");}
